...
export default {
  ...
  // 钱包管理页面
  'entry.title': '钱包地址准备',
  'entry.description': '这里管理的是可转账的钱包地址，而不是账户身份本身。每个地址都携带独立的 seed-chain 状态。',
  'entry.benefit1.title': '地址恢复材料',
  'entry.benefit1.desc': '导入或创建的是地址级长期恢复材料，优先是 AddressRootSeed；老地址仍可能是兼容私钥。',
  'entry.benefit2.title': '协议状态可见',
  'entry.benefit2.desc': '每个地址都会显示注册状态、seed 状态和是否可转账。',
  'entry.benefit3.title': '恢复 seed 能力',
  'entry.benefit3.desc': '导入地址后，系统会结合后端返回的锚点和步数恢复本地 seed-chain 状态。',
  'entry.walletsAdded': '已准备地址',
  'entry.encryptionAlgo': '加密算法',
  'entry.selectAction': '准备钱包地址',
  'entry.selectActionDesc': '创建或导入至少一个可转账地址。系统会在这里显示每个地址的协议状态与可用性。',
  'entry.createWallet': '创建钱包地址',
  'entry.createWalletDesc': '生成新的地址恢复材料并初始化可转账状态',
  'entry.importWallet': '导入钱包地址',
  'entry.importWalletDesc': '使用地址恢复材料导入，并恢复该地址的 seed-chain 状态',
  'entry.addWalletFirst': '请先创建或导入至少一个可转账的钱包地址',
  'entry.enterPrivateKeyHex': '请输入私钥 Hex',
  'entry.userStatus': '用户状态',
  'entry.orgStatus': '组织状态',
  'entry.orgId': '组织ID',
  'entry.addressCount': '钱包地址',
  'entry.usableAddressCount': '可转账地址',
  'entry.totalBalance': '总余额',
  'entry.seedImportNotice': '提示：这里不会展示 seed 明文。导入地址时推荐输入 AddressRootSeed 恢复材料；老地址也兼容私钥。系统会据此恢复后续交易所需的 seed-chain 本地状态。',
  'entry.inOrg': '已加入组织',
  'entry.notInOrg': '散户模式',
  'entry.externalLocked': '外部导入暂未解锁',
  'entry.externalUnlocked': '外部已解锁',
  'entry.protocolReady': '可转账',
  'entry.protocolSyncing': '待同步',
  'entry.protocolRepair': '待修复',
  'entry.protocolReadonly': '只读',
  'entry.protocolPending': '推进中',
  'entry.protocolRegistering': '注册中',
  'entry.protocolRegisterFailed': '注册失败',
  'entry.protocolAwaitRegister': '待注册',
  'entry.protocolReasonReady': '地址协议状态完整，可用于后续转账。',
  'entry.protocolReasonSyncing': '地址协议状态尚未同步完整，请先刷新或完成注册。',
  'entry.protocolReasonRepair': '缺少本地 seed 私有状态，当前地址需要修复。',
  'entry.protocolReasonReadonly': '该地址当前仅可查看，暂不可转出。',
  'entry.protocolReasonPending': '该地址正在等待上一笔交易确认并推进 seed 步骤。',
  'entry.protocolReasonRegistering': '该地址正在向后端注册，请稍后重试。',
  'entry.protocolReasonRegisterFailed': '该地址注册失败，请修复后再继续。',
  'entry.protocolReasonAwaitRegister': '该地址会在进入主钱包页面后统一执行注册。',
  'entry.lockedNotice': '检测到 {count} 个未解锁地址。请先点击这些地址输入私钥解锁；如果无法解锁，请删除这些地址后再继续。',
  'entry.lockedNextBlocked': '还有 {count} 个地址未解锁，请先解锁或删除后再继续。',
  'entry.unlockAddressPrompt': '请输入地址恢复材料以解锁',
  ...
  'entry.privateKeyMismatch': '恢复材料与地址不匹配',
  'entry.unlockAddress': '解锁地址',
  'entry.unlockAddressInfo': '请输入地址',
  'entry.unlockAddressInfo2': '的恢复材料以解锁：',
  'entry.enterPrivateKey': '输入私钥 (Hex)',
  'entry.enterRecoveryMaterial': '输入地址恢复材料（arsk_... 或兼容私钥）',
  'entry.unlockFailed': '解锁失败',
  'entry.deleteFailed': '删除失败',

  // 新建账户页面
  'new.title': '创建账户身份',
  'new.description': '先生成账户级身份密钥对；真正可转账的钱包地址会在后续创建。',
  'new.benefit1.title': '账户身份密钥',
  'new.benefit1.desc': '这组密钥用于登录、账户级签名以及组织侧验签。',
  'new.benefit2.title': '本地保护',
  'new.benefit2.desc': '账户私钥只保留在本地浏览器，下一步会为它设置加密保护。',
  'new.benefit3.title': 'Seed 地址后创建',
  'new.benefit3.desc': '真正可花费的钱包地址会在钱包页创建，并携带 seed-chain 状态。',
  'new.ellipticCurve': '椭圆曲线',
  'new.signatureAlgo': '签名算法',
  'new.generateKeys': '生成账户身份',
  'new.generateKeysDesc': '系统将生成账户级身份密钥对；这还不是一个已经初始化好的可转账钱包地址。',
  'new.generating': '正在生成账户身份',
  'new.accountCreated': '账户身份已生成',
  'new.mainAddress': '账户地址',
  'new.privateKey': '账户私钥（Hex）',
  'new.publicKey': '账户公钥（X / Y Hex）',
  'new.accountAddressNotice': '这个账户地址用于身份标识和账户级签名。真正带有 seed-chain 状态的可转账钱包地址，会在进入钱包后再创建。',
  'new.doNotShare': '请勿泄露',
  ...
  'new.nextStep': '下一步：加密账户私钥',
  'new.keyTip': '下一步请先设置密码加密这把账户私钥。进入钱包后，请先创建第一个带 seed-chain 状态的钱包地址，再进行收付款。',
  ...
  // 导入钱包页面
  'import.title': '导入钱包',
  'import.description': '通过恢复材料恢复您的钱包地址，安全快捷',
  'import.account.title': '导入账户身份',
  'import.account.description': '通过账户私钥恢复账户身份与本地钱包数据。',
  'import.account.headerTitle': '导入账户身份',
  'import.account.headerDesc': '输入账户私钥以恢复账户身份、账户地址和已有钱包数据。',
  'import.account.scopeNotice': '这里导入的是账户身份私钥。进入钱包后，你仍可以继续创建或导入钱包地址。',
  'import.account.submit': '导入账户身份',
  'import.wallet.title': '导入钱包地址',
  'import.wallet.description': '通过地址恢复材料恢复钱包地址，并重建本地 seed-chain 状态。',
  'import.wallet.headerTitle': '导入钱包地址',
  'import.wallet.headerDesc': '输入地址恢复材料以恢复该地址的控制权，并同步 seed-chain 状态。',
  'import.wallet.scopeNotice': '推荐输入 AddressRootSeed 恢复材料（arsk_...）；老地址也兼容 64 位私钥。',
  'import.wallet.submit': '导入钱包地址',
  'import.wallet.inputLabel': '地址恢复材料',
  'import.wallet.inputPlaceholder': '请输入 arsk_... 或兼容的 64 位私钥',
  'import.wallet.formatHint': '推荐输入 arsk_...；也兼容旧的 64 位私钥。',
  'import.wallet.securityTip': '请在安全环境中输入地址恢复材料。恢复材料仅保存在本地浏览器中。',
  'import.wallet.requiredMaterial': '请输入地址恢复材料',
  'import.wallet.inputFormatError': '请输入地址恢复材料（arsk_...）或兼容的64位私钥',
  'import.benefit1.title': '本地安全',
  'import.benefit1.desc': '恢复材料仅在本地存储，不会上传服务器',
  'import.benefit2.title': '钱包恢复',
  'import.benefit2.desc': '使用恢复材料快速恢复您的钱包',
  'import.benefit3.title': '密钥兼容',
  'import.benefit3.desc': '支持 AddressRootSeed 和兼容私钥导入',
  'import.keyLength': '密钥长度',
  'import.importWallet': '导入钱包',
  'import.importWalletDesc': '输入恢复材料以恢复钱包地址并管理资产',
  ...
  'wallet.exportPrivateKey': '导出地址恢复材料',
  'wallet.exportKeyShort': '导出恢复材料',
  ...
  'wallet.exportRootKeyNotice': '这是该地址的长期根私钥。系统会结合链上 SeedAnchor 与 SeedChainStep 恢复后续 seed-chain 状态，因此这里不直接展示 seed 明文。',
  'wallet.exportRootSeedNotice': '推荐导出：这是该地址的 AddressRootSeed 恢复材料。它是当前架构下更优先的长期恢复入口。',
  'wallet.exportAccountKeyNotice': '这是账户身份私钥，用于登录和账户级签名，不是地址级恢复材料。',
  'wallet.privateKeyWarning': '警告：私钥即资产。切勿将私钥透露给任何人，或在不安全的网站输入。',
  'wallet.noPrivateKey': '该地址无可导出私钥',
  'wallet.seedStep': 'Seed 步数',
  'wallet.registrationStatus': '注册状态',
  'wallet.registrationRegistered': '已注册',
  'wallet.registrationPending': '注册中',
  'wallet.registrationFailed': '注册失败',
  'wallet.registrationUnknown': '未知',
  'wallet.copy': '复制',
  'wallet.copied': '已复制！',
  'wallet.syncing': '同步中...',
  ...
  'walletModal.privateKeyLabel': '地址恢复材料',
  'walletModal.privateKeyDoNotShare': '恢复材料 (请勿泄露)',
  'walletModal.privateKeyFormatError': '私钥格式不正确：需为 64 位十六进制字符串',
  'walletModal.pleaseEnterPrivateKey': '请输入私钥 Hex',
  'walletModal.pleaseEnterRecoveryMaterial': '请输入地址恢复材料',
  'walletModal.recoveryMaterialFormatError': '请输入地址恢复材料（arsk_...）或兼容的64位私钥',
  'walletModal.recoveryMaterialPlaceholder': '请输入 arsk_... 或兼容的 64 位私钥',
  ...
  'transfer.peerNotReachableHint': '担保节点未在线，暂时无法发送。',
  'transfer.noAvailableGuarantorHint': '没有可用的担保节点，暂时无法发送。',
